...
namespace SudokuNator5000
{
    public class Program
    {
        ...
        {
            /*int[,] mat = StrToMat("130008900008000000790000080000600400003009070050020800001007090000500006000040200");
            ...
            brd.LoadBoard(mat);
            BoardSolver slv = new BoardSolver(brd);
            slv.Solve();
            brd.PrintBoard();
            slv.RevertChanges(10);
            brd.PrintBoard();
        }
