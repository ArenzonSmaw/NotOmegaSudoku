    ...
    public class InvalidInputTest
    {
        ...
        public void TestInvalidChar1()
        {
            Assert.ThrowsException<InvalidCharacterException>(() => {
                int[,] input = Program.StrToMat("00805207V09104000670580040057008F20460000001781076B03515640032002403070038A095641");
        ...
        {
            Assert.ThrowsException<InvalidCharacterException>(() => {
                int[,] input = Program.StrToMat("0080520700910400067058004005.0083204600000017810764035156400-20024030700387095641");
        ...
        {
            Assert.ThrowsException<InvalidCharacterException>(() => {
                int[,] input = Program.StrToMat("0781430006459708019100002400960000155000190608014059007845010000608300000 9700184");
        ...
        public void TestInvalidInputSize1()
        {
            Assert.ThrowsException<InvalidBoardSizesException>(() => {
                int[,] input = Program.StrToMat("00184");
        ...
        {
            Assert.ThrowsException<InvalidBoardSizesException>(() => {
                int[,] input = Program.StrToMat("0012152152150152014514852125414852145202585485258548542589548652358784528614743684");
