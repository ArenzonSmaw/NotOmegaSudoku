...
namespace SudokuTester
{
    ...
    public class ValidTest
    {
        ...
        {
            int[,] input = Program.StrToMat("008052070091040006705800400570083204600000017810764035156400320024030700387095641");
        ...
        {
            int[,] input = Program.StrToMat("000050780000600010090020603100400000054260090007030001582910370000002500003000129");
        ...
        {
            int[,] input = Program.StrToMat("060107004010480650204659300009008000830746020046900081158300079072090006693000140");
        ...
        {
            int[,] input = Program.StrToMat("078143000645970801910000240096000015500019060801405900784501000060830000059700184");
        ...
        {
            int[,] input = Program.StrToMat("451000070000006800020700095210498060045203189089605243068007904030000720072150030");
        ...
        {
            int[,] input = Program.StrToMat("050080000004100900100009020008300700070004009000002010090600050003040006600008300");
        ...
        {
            int[,] input = Program.StrToMat("010000075000051604600007030007046001000700300540310000050003000800060000900000500");
        ...
        {
            int[,] input = Program.StrToMat("500090106103005092060020030001000009050000300006007001000870000002000600900200005");
        ...
        {
            int[,] input = Program.StrToMat("800003000500020001409605700000100309000004002050930060000200600000050070760300000");
